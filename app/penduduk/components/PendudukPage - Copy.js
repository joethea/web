 ...
 useEffect(() => {
  ...
  return (
    <div className="max-w-full mx-auto relative">
      ...
      {/* HEADER / ACTION BAR */}
<div className="bg-white border-b-4 border-green-700 shadow-sm rounded-lg p-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-4 sticky top-0 z-40 relative">
  {/* Judul */}
